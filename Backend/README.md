...
Returns a JSON object containing a JWT token and the captain data.
...
**Method:** `GET`  
**Description:** Retrieve the currently authenticated captain's profile.
...
Returns the captain object for the authenticated session:
...
**URL:** `/captains/logout`  
**Method:** `GET`  
**Description:** Logout the current captain and invalidate their JWT.
